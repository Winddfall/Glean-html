...
const testimonials = [
  ["以前收藏夹里有几十个链接，现在我能记得为什么收藏，也知道下一步要做什么。", "白鼠鼠", "独立产品经理", "林"],
  ["最喜欢的是目标视角。做竞品研究时，资料不会再散落在十几个标签页里。", "Windfall", "增长负责人", "M"],
  ["摸鱼池塘很妙，降低了记录压力，真正有价值的内容之后又能被拾起来。", "阿盛", "内容创作者", "盛"],
  ["它不是逼我整理，而是在我浏览的时候顺手完成整理，这一点很重要。", "Yuki", "研究生", "Y"],
] as const;

const faqs = [
  ["拾知和普通网页收藏夹有什么不同？", "收藏夹保存的是链接，拾知保存的是链接与你当前目标之间的关系。它会提取摘要、发现和关键词，并在之后的检索与行动中重新组织这些内容。"],
    ...
    <>
      ...
      <section id="faq" className="faq-section cc-section">
        <div className="cc-container grid gap-14 lg:grid-cols-[.72fr_1.28fr]">
          <Reveal variant="left" className="faq-title"><span className="eyebrow">FAQ</span><h2>关于拾知，<br />你可能还想知道</h2><p>如果还有别的问题，欢迎通过右上角的社区入口找到我们。</p></Reveal>
